...
import com.usa.edu.co.ciclo3.reports.ClientCount;
import com.usa.edu.co.ciclo3.repository.crud.ReservationCrudRepository;
...
public class ReservationRepository {
    ...
    public Optional<Reservation> getReservation(int id){return CrudRepository.findById(id);}
    public Reservation save(Reservation reservation){return CrudRepository.save(reservation);}
    public void delete(Reservation reservation){CrudRepository.delete(reservation);}
